...
public class Element_of_equation {
    ...
    Element_of_equation (String some)
    {
        ...
        if (in0 == '$') {
            type = Const.ERROR;
            //MainActivity.debugview.setText("Error: " + some + " ");
        }else
        ...
        if (some.length()==1&&'A'<=in0&&in0<='Z')
            ...
            switch (in0){
                ...
                case '!': type = Const.FUNCRE; func = "!"; break;
    ...
    public static String Element_to_String (Element_of_equation in)
    {
        ...
        switch (in.type)
        {
            ...
            case Const.FUNC:    out = in.func;break;
            case Const.FUNCRE:  out = in.func;break;
        ...
        if (in_length == 1) {
            ...
            for (int i = 1; i < in_length; i++) {
                ...
                if (type==1&&(('0'<=temp_c&&temp_c<='9')||
                    ...
                    if (temp_c=='E'&&'0'<=temp_cm&&temp_cm>='9'&&(('0'<=temp_cp&&temp_cp>='9')||temp_cp=='-'||temp_cp=='+')){
                        num2++;
                        if (num2 > 1)
